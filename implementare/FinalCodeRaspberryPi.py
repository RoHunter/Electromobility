...
#         serial.write([0x46])
#     if angle < 115 and angle > 95:
#         serial.write([0x72])
#     if angle < 180 and angle > 115:
    if angle > 0 and angle < 256:
        nicer_angle = int(angle)
        serial.write([nicer_angle])
